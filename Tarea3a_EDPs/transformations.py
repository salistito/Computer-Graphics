...
def perspective(fovy, aspect, near, far): # No la vimos muchos pero consigue lo mismo que frustum (efecto de perspectiva)
...
def lookAt(eye, at, up): # Transformación de vista 
