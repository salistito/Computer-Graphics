...
def createAxis(length=1.0): # Crealos ejes, dibujará lineas pero de momento no lo sabe 
...
def createDecima6TextureQuad(image_filename, nx0=0, ny0= 0 ,nx=1, ny=1):
    # Defining locations and texture coordinates for each vertex of the shape    
    vertices = [
    #   positions        texture
        -0.5, -0.5, 0.0,  nx0, ny,
...
def createColorNormalsPizza(r, g, b):
    ...
    # Right
        0.5, -0.5,  0.5, r, g, b,  1, 1, 0,
        0.0,  0.5,  0.5, r, g, b,  1, 1, 0,
        0.5, -0.5, -0.5, r, g, b,  1, 1, 0,
        0.0,  0.5, -0.5, r, g, b,  1, 1, 0,
